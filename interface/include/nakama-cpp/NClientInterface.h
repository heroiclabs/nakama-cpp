...
public:
  ...
  linkEmailAsync(NSessionPtr session, const std::string& email, const std::string& password) = 0;
   ...
   * @param id A device identifier usually obtained from a platform API.
   */
  virtual std::future<void> linkDeviceAsync(NSessionPtr session, const std::string& id) = 0;
   ...
   * @param accessToken An OAuth access token from the Google SDK.
   */
  virtual std::future<void> linkGoogleAsync(NSessionPtr session, const std::string& accessToken) = 0;
  ...
  virtual std::future<void> linkGameCenterAsync(
      ...
      const std::string& salt,
      const std::string& signature,
      const std::string& publicKeyUrl) = 0;
   ...
   * @param token The ID token received from Apple.
   */
  virtual std::future<void> linkAppleAsync(NSessionPtr session, const std::string& token) = 0;
   ...
   * @param token An authentication token from the Steam network.
   */
  virtual std::future<void> linkSteamAsync(NSessionPtr session, const std::string& token) = 0;
   ...
   * @param id A custom identifier usually obtained from an external authentication service.
   */
  virtual std::future<void> linkCustomAsync(NSessionPtr session, const std::string& id) = 0;
   ...
   * @param accessToken An OAuth access token from the Facebook SDK.
   */
  virtual std::future<void> unlinkFacebookAsync(NSessionPtr session, const std::string& accessToken) = 0;
   ...
   */
  virtual std::future<void>
  unlinkEmailAsync(NSessionPtr session, const std::string& email, const std::string& password) = 0;
   ...
   * @param accessToken An OAuth access token from the Google SDK.
   */
  virtual std::future<void> unlinkGoogleAsync(NSessionPtr session, const std::string& accessToken) = 0;
   ...
   * @param token An Apple authentication token.
   */
  virtual std::future<void> unlinkAppleAsync(NSessionPtr session, const std::string& token) = 0;
   ...
   * @param token An authentication token from the Steam network.
   */
  virtual std::future<void> unlinkSteamAsync(NSessionPtr session, const std::string& token) = 0;
   ...
   * @param id A device identifier usually obtained from a platform API.
   */
  virtual std::future<void> unlinkDeviceAsync(NSessionPtr session, const std::string& id) = 0;
   ...
   * @param id A custom identifier usually obtained from an external authentication service.
   */
  virtual std::future<void> unlinkCustomAsync(NSessionPtr session, const std::string& id) = 0;
  ...
  virtual std::future<NUsers> getUsersAsync(
      ...
      const std::vector<std::string>& ids,
      const std::vector<std::string>& usernames = {},
      const std::vector<std::string>& facebookIds = {}) = 0;
   ...
   * @param groupId The group id to to remove.
   */
  virtual std::future<void> deleteGroupAsync(NSessionPtr session, const std::string& groupId) = 0;
   ...
   */
  virtual std::future<void>
  addGroupUsersAsync(NSessionPtr session, const std::string& groupId, const std::vector<std::string>& ids) = 0;
   ...
   * @param groupId The id of the group to join.
   */
  virtual std::future<void> joinGroupAsync(NSessionPtr session, const std::string& groupId) = 0;
   ...
   * @param groupId The id of the group to leave.
   */
  virtual std::future<void> leaveGroupAsync(NSessionPtr session, const std::string& groupId) = 0;
   ...
   * @param cursor A cursor for the current position in the groups to list.
   */
  virtual std::future<NGroupListPtr>
  listGroupsAsync(NSessionPtr session, const std::string& name, int32_t limit = 0, const std::string& cursor = "") = 0;
   ...
   */
  virtual std::future<void>
  promoteGroupUsersAsync(NSessionPtr session, const std::string& groupId, const std::vector<std::string>& ids) = 0;
   ...
   */
  virtual std::future<void>
  demoteGroupUsersAsync(NSessionPtr session, const std::string& groupId, const std::vector<std::string>& ids) = 0;
   ...
   * @param leaderboardId The id of the leaderboard with the record to be deleted.
   */
  virtual std::future<void> deleteLeaderboardRecordAsync(NSessionPtr session, const std::string& leaderboardId) = 0;
   ...
   */
  virtual std::future<void>
  deleteNotificationsAsync(NSessionPtr session, const std::vector<std::string>& notificationIds) = 0;
   ...
   * @param tournamentId The id of the tournament to join.
   */
  virtual std::future<void> joinTournamentAsync(NSessionPtr session, const std::string& tournamentId) = 0;
   ...
   * @param objects The objects to write.
   */
  virtual std::future<NStorageObjectAcks>
  writeStorageObjectsAsync(NSessionPtr session, const std::vector<NStorageObjectWrite>& objects) = 0;
   ...
   * @param objectIds The objects to read.
   */
  virtual std::future<NStorageObjects>
  readStorageObjectsAsync(NSessionPtr session, const std::vector<NReadStorageObjectId>& objectIds) = 0;
   ...
   */
  virtual std::future<void>
  deleteStorageObjectsAsync(NSessionPtr session, const std::vector<NDeleteStorageObjectId>& objectIds) = 0;
