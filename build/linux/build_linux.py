...
def copy_ssl_lib():
    copy_file(BUILD_DIR + '/third_party/grpc/third_party/boringssl-with-bazel/' + BUILD_MODE + '/crypto/libcrypto.a', release_libs_path)
    copy_file(BUILD_DIR + '/third_party/grpc/third_party/boringssl-with-bazel/' + BUILD_MODE + '/ssl/libssl.a', release_libs_path)
