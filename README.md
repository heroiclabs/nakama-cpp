...
(7) Consumers  will need to update to the new commit as the `baseline` value in their `vcpkg.json`. They may need to update to the new port increment in their manifest.
