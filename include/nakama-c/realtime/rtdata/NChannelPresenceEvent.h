...
typedef struct NAKAMA_API NChannelPresenceEvent
{
    ...
    const NUserPresence* joins;        ///< Presences joining the channel as part of this event, if any.
    uint16_t joinsCount;
    const NUserPresence* leaves;       ///< Presences leaving the channel as part of this event, if any.
